...
const {getAllClassroom} = useClassroomStore();
const {classroom, classroomList} = storeToRefs(useClassroomStore())
const isShowListing = ref(true)
const isLoading = ref(false)

const getAllClassroomModel = async () => {
...
<template>
  <template v-if="isShowListing">
    ...
    <table>
      ...
      <tr v-for="classroom in classroomList" :key="classroom.id">
        <td>{{ classroom.id }}</td>
